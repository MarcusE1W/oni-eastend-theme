" -----------------------------------------------------------------------------
" File: eastend-vim.vim
" Description: Light cafe late theme based on the retro groove color scheme for Vim
" Author: morhetz <morhetz@gmail.com> (mostly)
...
let s:gb.dark0       = ['#444040', 235]     " 40-40-40 ui background for txt
...
let s:gb.light0      = ['#f9f2e0', 229]     " editor bg color #f9f2e0
...
let s:gb.neutral_red    = ['#d35400', 124]     " 204-36-29 pumpkin
let s:gb.neutral_green  = ['#B6DB2F', 106]     " 152-151-26 pear
let s:gb.neutral_yellow = ['#FFDE7C', 172]     " 215-153-33 mellow yellow
let s:gb.neutral_blue   = ['#2649de', 66]      " 69-133-136 blue
let s:gb.neutral_purple = ['#9356a4', 132]     " 177-98-134 purple
let s:gb.neutral_aqua   = ['#61aeee', 72]      " 104-157-106 peterRiver
let s:gb.neutral_orange = ['#f39c12', 166]     " 214-93-14 orange
